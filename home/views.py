...
def gen_resume(request):
    ...
    if request.method == 'POST':
        ...
        context = {
            ...
            # Experience (Up to 5)
            'company1': request.POST.get('company1', ''), 'post1': request.POST.get('post1', ''), 'duration1': request.POST.get('duration1', ''), 'location1': request.POST.get('location1', ''), 'lin11': request.POST.get('lin11', ''), 'achievements1': request.POST.get('achievements1', ''),
            'company2': request.POST.get('company2', ''), 'post2': request.POST.get('post2', ''), 'duration2': request.POST.get('duration2', ''), 'location2': request.POST.get('location2', ''), 'lin21': request.POST.get('lin21', ''), 'achievements2': request.POST.get('achievements2', ''),
            'company3': request.POST.get('company3', ''), 'post3': request.POST.get('post3', ''), 'duration3': request.POST.get('duration3', ''), 'location3': request.POST.get('location3', ''), 'lin31': request.POST.get('lin31', ''), 'achievements3': request.POST.get('achievements3', ''),
            'company4': request.POST.get('company4', ''), 'post4': request.POST.get('post4', ''), 'duration4': request.POST.get('duration4', ''), 'location4': request.POST.get('location4', ''), 'lin41': request.POST.get('lin41', ''), 'achievements4': request.POST.get('achievements4', ''),
            'company5': request.POST.get('company5', ''), 'post5': request.POST.get('post5', ''), 'duration5': request.POST.get('duration5', ''), 'location5': request.POST.get('location5', ''), 'lin51': request.POST.get('lin51', ''), 'achievements5': request.POST.get('achievements5', ''),
            # Projects (Up to 5)
            'project1': request.POST.get('project1', ''), 'durat1': request.POST.get('durat1', ''), 'desc1': request.POST.get('desc1', ''), 'project_tech1': request.POST.get('project_tech1', ''), 'project_url1': request.POST.get('project_url1', ''),
            'project2': request.POST.get('project2', ''), 'durat2': request.POST.get('durat2', ''), 'desc2': request.POST.get('desc2', ''), 'project_tech2': request.POST.get('project_tech2', ''), 'project_url2': request.POST.get('project_url2', ''),
            'project3': request.POST.get('project3', ''), 'durat3': request.POST.get('durat3', ''), 'desc3': request.POST.get('desc3', ''), 'project_tech3': request.POST.get('project_tech3', ''), 'project_url3': request.POST.get('project_url3', ''),
            'project4': request.POST.get('project4', ''), 'durat4': request.POST.get('durat4', ''), 'desc4': request.POST.get('desc4', ''), 'project_tech4': request.POST.get('project_tech4', ''), 'project_url4': request.POST.get('project_url4', ''),
            'project5': request.POST.get('project5', ''), 'durat5': request.POST.get('durat5', ''), 'desc5': request.POST.get('desc5', ''), 'project_tech5': request.POST.get('project_tech5', ''), 'project_url5': request.POST.get('project_url5', ''),
            # Education (Up to 5)
            'degree1': request.POST.get('degree1', ''), 'college1': request.POST.get('college1', ''), 'year1': request.POST.get('year1', ''), 'gpa1': request.POST.get('gpa1', ''), 'honors1': request.POST.get('honors1', ''),
            'degree2': request.POST.get('degree2', ''), 'college2': request.POST.get('college2', ''), 'year2': request.POST.get('year2', ''), 'gpa2': request.POST.get('gpa2', ''), 'honors2': request.POST.get('honors2', ''),
            'degree3': request.POST.get('degree3', ''), 'college3': request.POST.get('college3', ''), 'year3': request.POST.get('year3', ''), 'gpa3': request.POST.get('gpa3', ''), 'honors3': request.POST.get('honors3', ''),
            'degree4': request.POST.get('degree4', ''), 'college4': request.POST.get('college4', ''), 'year4': request.POST.get('year4', ''), 'gpa4': request.POST.get('gpa4', ''), 'honors4': request.POST.get('honors4', ''),
            'degree5': request.POST.get('degree5', ''), 'college5': request.POST.get('college5', ''), 'year5': request.POST.get('year5', ''), 'gpa5': request.POST.get('gpa5', ''), 'honors5': request.POST.get('honors5', ''),
            # References
            'reference_name1': request.POST.get('reference_name1', ''), 'reference_title1': request.POST.get('reference_title1', ''), 'reference_contact1': request.POST.get('reference_contact1', ''),
            'reference_name2': request.POST.get('reference_name2', ''), 'reference_title2': request.POST.get('reference_title2', ''), 'reference_contact2': request.POST.get('reference_contact2', ''),
            # Board positions
            'board1': request.POST.get('board1', ''), 'board_role1': request.POST.get('board_role1', ''), 'board_year1': request.POST.get('board_year1', ''),
            'board2': request.POST.get('board2', ''), 'board_role2': request.POST.get('board_role2', ''), 'board_year2': request.POST.get('board_year2', ''),
            # Awards
            'award1': request.POST.get('award1', ''), 'award_year1': request.POST.get('award_year1', ''),
            'award2': request.POST.get('award2', ''), 'award_year2': request.POST.get('award_year2', ''),
        }
...
def get_resume_context(post_data):
    ...
    return {
        ...
        # Experience (Up to 5)
        'company1': post_data.get('company1', ''), 'post1': post_data.get('post1', ''), 'duration1': post_data.get('duration1', ''), 'location1': post_data.get('location1', ''), 'lin11': post_data.get('lin11', ''), 'achievements1': post_data.get('achievements1', ''),
        'company2': post_data.get('company2', ''), 'post2': post_data.get('post2', ''), 'duration2': post_data.get('duration2', ''), 'location2': post_data.get('location2', ''), 'lin21': post_data.get('lin21', ''), 'achievements2': post_data.get('achievements2', ''),
        'company3': post_data.get('company3', ''), 'post3': post_data.get('post3', ''), 'duration3': post_data.get('duration3', ''), 'location3': post_data.get('location3', ''), 'lin31': post_data.get('lin31', ''), 'achievements3': post_data.get('achievements3', ''),
        'company4': post_data.get('company4', ''), 'post4': post_data.get('post4', ''), 'duration4': post_data.get('duration4', ''), 'location4': post_data.get('location4', ''), 'lin41': post_data.get('lin41', ''), 'achievements4': post_data.get('achievements4', ''),
        'company5': post_data.get('company5', ''), 'post5': post_data.get('post5', ''), 'duration5': post_data.get('duration5', ''), 'location5': post_data.get('location5', ''), 'lin51': post_data.get('lin51', ''), 'achievements5': post_data.get('achievements5', ''),
        # Projects (Up to 5)
        'project1': post_data.get('project1', ''), 'durat1': post_data.get('durat1', ''), 'desc1': post_data.get('desc1', ''), 'project_tech1': post_data.get('project_tech1', ''), 'project_url1': post_data.get('project_url1', ''),
        'project2': post_data.get('project2', ''), 'durat2': post_data.get('durat2', ''), 'desc2': post_data.get('desc2', ''), 'project_tech2': post_data.get('project_tech2', ''), 'project_url2': post_data.get('project_url2', ''),
        'project3': post_data.get('project3', ''), 'durat3': post_data.get('durat3', ''), 'desc3': post_data.get('desc3', ''), 'project_tech3': post_data.get('project_tech3', ''), 'project_url3': post_data.get('project_url3', ''),
        'project4': post_data.get('project4', ''), 'durat4': post_data.get('durat4', ''), 'desc4': post_data.get('desc4', ''), 'project_tech4': post_data.get('project_tech4', ''), 'project_url4': post_data.get('project_url4', ''),
        'project5': post_data.get('project5', ''), 'durat5': post_data.get('durat5', ''), 'desc5': post_data.get('desc5', ''), 'project_tech5': post_data.get('project_tech5', ''), 'project_url5': post_data.get('project_url5', ''),
        # Education (Up to 5)
        'degree1': post_data.get('degree1', ''), 'college1': post_data.get('college1', ''), 'year1': post_data.get('year1', ''), 'gpa1': post_data.get('gpa1', ''), 'honors1': post_data.get('honors1', ''),
        'degree2': post_data.get('degree2', ''), 'college2': post_data.get('college2', ''), 'year2': post_data.get('year2', ''), 'gpa2': post_data.get('gpa2', ''), 'honors2': post_data.get('honors2', ''),
        'degree3': post_data.get('degree3', ''), 'college3': post_data.get('college3', ''), 'year3': post_data.get('year3', ''), 'gpa3': post_data.get('gpa3', ''), 'honors3': post_data.get('honors3', ''),
        'degree4': post_data.get('degree4', ''), 'college4': post_data.get('college4', ''), 'year4': post_data.get('year4', ''), 'gpa4': post_data.get('gpa4', ''), 'honors4': post_data.get('honors4', ''),
        'degree5': post_data.get('degree5', ''), 'college5': post_data.get('college5', ''), 'year5': post_data.get('year5', ''), 'gpa5': post_data.get('gpa5', ''), 'honors5': post_data.get('honors5', ''),
        # References
        'reference_name1': post_data.get('reference_name1', ''), 'reference_title1': post_data.get('reference_title1', ''), 'reference_contact1': post_data.get('reference_contact1', ''),
        'reference_name2': post_data.get('reference_name2', ''), 'reference_title2': post_data.get('reference_title2', ''), 'reference_contact2': post_data.get('reference_contact2', ''),
        # Board positions
        'board1': post_data.get('board1', ''), 'board_role1': post_data.get('board_role1', ''), 'board_year1': post_data.get('board_year1', ''),
        'board2': post_data.get('board2', ''), 'board_role2': post_data.get('board_role2', ''), 'board_year2': post_data.get('board_year2', ''),
        # Awards
        'award1': post_data.get('award1', ''), 'award_year1': post_data.get('award_year1', ''),
        'award2': post_data.get('award2', ''), 'award_year2': post_data.get('award_year2', ''),
    }
